...
| 功能 | 描述 | 优先级 | 进度 |
|------|------|--------|------|
| 关卡定义 | YAML/JSON 格式的关卡配置文件 | P0 | ⬜ 待开发 |
| 难度分级 | 初级/中级/高级三个难度等级 | P0 | ⬜ 待开发 |
| 分类标签 | 按功能分类：导航、编辑、搜索、调试等 | P0 | ⬜ 待开发 |
| 场景描述 | 每个关卡包含实际使用场景的描述 | P0 | ⬜ 待开发 |
...
| 功能 | 描述 | 优先级 | 进度 |
|------|------|--------|------|
| VSCode 默认 | 支持 VSCode 原生快捷键 | P0 | ⬜ 待开发 |
| VSCode + Vim | 支持 Vim 扩展的额外快捷键 | P0 | ⬜ 待开发 |
| 平台适配 | 自动识别 macOS/Windows/Linux | P0 | ⬜ 待开发 |
...
| 功能 | 描述 | 优先级 | 进度 |
|------|------|--------|------|
| 进度保存 | 本地保存训练进度 | P0 | ⬜ 待开发 |
| 完成统计 | 已完成/总关卡数量 | P0 | ⬜ 待开发 |
| 响应时间 | 记录每次回答的响应时间 | P1 | ⬜ 待开发 |
